...
// ─── Typography ───────────────────────────────────────────────────────────────
/**
 * Complete Material3 typography scale using Inter (Google Fonts).
 *
 * Spec:
 *  Display  → Bold  | 57sp / 45sp
 *  Headline → Bold  | 32sp / 28sp / 24sp
 *  Title    → SemiBold | 22sp / 16sp / 14sp
 *  Body     → Normal | 16sp / 14sp / 12sp
 *  Label    → Medium | 14sp / 12sp / 11sp
 */
